...
/**
 * DfuTargetDownloadFlags:
 * @DFU_TARGET_DOWNLOAD_FLAG_NONE:		No flags set
 * @DFU_TARGET_DOWNLOAD_FLAG_VERIFY:		Verify the download once complete
 * @DFU_TARGET_DOWNLOAD_FLAG_HOST_RESET:	Reset the bus when complete
 *
 * The optional flags used for transfering firmware.
 **/
typedef enum {
	DFU_TARGET_DOWNLOAD_FLAG_NONE		= 0,
	DFU_TARGET_DOWNLOAD_FLAG_VERIFY		= (1 << 0),
	DFU_TARGET_DOWNLOAD_FLAG_HOST_RESET	= (1 << 1),
	/* private */
	DFU_TARGET_DOWNLOAD_FLAG_LAST,
} DfuTargetDownloadFlags;
